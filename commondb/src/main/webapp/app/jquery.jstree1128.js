	...
	$.jstree.plugin("checkbox", {
		...
		_fn : {
			...
			change_state : function (obj, state) {
				...
				else { obj.removeClass("jstree-unchecked jstree-undetermined").addClass("jstree-checked"); this.data.ui.last_selected = obj; }
...
(function ($) {
	...
	$(function () {
		var css_string = '' + 
			...
			'#vakata-contextmenu ul { min-width:180px; width:200; max-width:220} ' + 
