...
public class PicAttrDataCriteria
{
  ...
  public PicAttrDataCriteria()
  {
    this.oredCriteria = new ArrayList();
  }
  
  protected PicAttrDataCriteria(PicAttrDataCriteria example)
  {
  ...
  public static class Criteria
  {
    ...
    public Criteria andPreviewFilePathIn(List values)
    {
      addCriterion("preview_file_path in", values, "previewFilePath");
      return this;
    }
    
    public Criteria andPreviewFilePathNotIn(List values)
    {
