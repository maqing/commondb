...
public class REntityHierarchyDataCriteria
{
  protected String orderByClause;
  protected List oredCriteria;
  
  public REntityHierarchyDataCriteria()
  {
    this.oredCriteria = new ArrayList();
  }
  
  protected REntityHierarchyDataCriteria(REntityHierarchyDataCriteria example)
  {
