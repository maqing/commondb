...
public class Test
{
  public static void main(String[] args)
  {
    JSONString obj = new JSONString()
    {
      ...
      {
        return
//          "{" + JSONObject.quote(Test.this) + ":" + JSONObject.doubleToString(this.aNumber) + "}";
        "{" + JSONObject.quote("test") + ":" + JSONObject.doubleToString(this.aNumber) + "}";
      }

      public String toString()
      {
        return
          getString() + " " + getNumber() + " " + isBoolean() + "." + getBENT() + " " + getX();
      }
    };
    try
    {
